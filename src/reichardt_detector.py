...
def run_simulation(
    ...
    static_kwargs = {'model':'w : amp', 'on_pre': 'I_syn_post += w'}
    ...
    S_left_inhib_relay = b.Synapses(left_inhib_group, left_relay_group, **static_kwargs)
    ...
    S_right_inhib_relay = b.Synapses(right_inhib_group, right_relay_group, **static_kwargs)
    ...
    # ────────────────────────────────────────────────
    S_right_to_left = b.Synapses(right_output_group, left_output_group, **static_kwargs)
    S_right_to_left.connect()  # single connection
    S_right_to_left.w = lateral_inhib_weight

    S_left_to_right = b.Synapses(left_output_group, right_output_group, **static_kwargs)
